...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        # Daniel ha escuchado acerca de una nueva aplicacion genial en linea "to-do app"
        ...
        self.assertEqual(inputbox.get_attribute('placeholder'), 'Ingresa un Elemento a To-Do')
